<?php
    ...
    if (isset($_POST['enviar'])) {
        ...
        $apellido_c = $_POST['Apellidos'];
        $tipo_d_c = $_POST['Tipodocumento'];
        ...
        if ($validando->num_rows > 0) {
            ...
            $insertarDatos = "INSERT INTO cliente(nombre_c, apellido_c,tipo_d_c,id_cliente,cel_c,email_c) 
                                                    VALUES('$nombre_c',
                                                        '$apellido_c',
                                                        '$tipo_d_c',
                                                        '$id_cliente',
...
*{background-color: white;}
    ...
    <body>
        ...
        <section id="Registro"  class="Formulario">
            ...
            <p>
                <select name="Tipodocumento" name="" required="">
            ...
            <!--Debes registrar en la base de datos esta cuestion -->
            </div>
            </form>
        </section>
