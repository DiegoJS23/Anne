<?php
    ...
    $modificar = "SELECT * FROM estilista WHERE id_estilista = '$id'";
...
//realizar la consulta para modificar los datos
        $actualiza = "UPDATE estilista SET nombre_e = '$nombre', apellido_e ='$apellido', cel_e = '$celular', email_e = '$email' WHERE id_estilista = '$id'";
    ...
    <body>
        ...
        <section id="Registro"  class="Formulario">
            <form action="" method="POST">
               ...
               <input type="hidden" name="id" value="<?php echo $dato['id_estilista']; ?>" >
                <input type="text" name="mNombre" value="<?php echo $dato['nombre_e']; ?>" placeholder="Nombre" required> <br> <br> 
                <input type="text" name="mApellidos" value="<?php echo $dato['apellido_e']; ?>" placeholder="Apellidos" required> <br> <br> 
            <!--<p>
                <select name="mTipodocumento" value="<?php echo $dato['tipo_d_e']; ?>" required>
            ...
            <input type="text" name="mCelular" value="<?php echo $dato['cel_e']; ?>" placeholder="Celular o teléfono" required> <br> <br>
            <!--Mandar correo diciendo que se actualizó el correo-->
            <input type="text" name="mEmail" value="<?php echo $dato['email_e']; ?>" placeholder="Email" required> <br> <br>
